  ...
  return (
    <SectionWrapper title="Connection" description="Kubeconfig context details for this cluster.">
      <Stack direction="column" gap={0}>
        ...
        <InfoRow
          label="Cluster"
          value={connLabels?.cluster ?? (connData?.cluster != null ? String(connData.cluster) : undefined)}
        />
        <InfoRow
          label="Kubeconfig"
          value={connLabels?.kubeconfig ?? (connData?.kubeconfig != null ? String(connData.kubeconfig) : undefined)}
        />
