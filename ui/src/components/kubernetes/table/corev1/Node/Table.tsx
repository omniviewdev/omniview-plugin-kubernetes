      ...
      withClusterResourceColumns(
        [
          ...
          },
          {
            ...
            accessorFn: (row) =>
              convertByteUnits({ from: row?.status?.capacity?.['ephemeral-storage'] || '' }),
            size: 120,
            meta: {
              defaultHidden: true,
            },
          },
          {
            ...
            cell: ({ getValue }) => (
              <ConditionsCell conditions={getValue() as Condition[] | undefined} />
            ),
            size: 250,
          },
        ],
      ...
      actions: [
        {
          ...
          action: (ctx: DrawerContext<Node>) => {
            void show({
              ...
              body: (
                <span>
                  This will mark the node as unschedulable. No new pods will be placed on it.
                </span>
              ),
              confirmLabel: 'Cordon',
              cancelLabel: 'Cancel',
        ...
        },
        {
          ...
          action: (ctx: DrawerContext<Node>) => {
            void show({
              ...
              body: (
                <span>
                  This will evict all pods from the node and cordon it. DaemonSet-managed pods will
                  be ignored.
                </span>
              ),
              confirmLabel: 'Drain',
            ...
            void createSession({
              ...
              opts: {
                ...
                params: {
                  ...
                  ...(nodeShellConfig?.command
                    ? { node_shell_command: nodeShellConfig.command }
                    : {}),
                },
              },
            }).then(() => closeDrawer());
        ...
        },
        {
          ...
          action: (ctx: DrawerContext<Node>) => {
            void show({
              ...
              body: (
                <span>
                  Are you sure you want to delete the Node <code>{ctx.data?.metadata?.name}</code>?
